...
public:
    static tensor_list forward(AutogradContext* ctx, const std::string& strategy,
        ...
        static auto fwd =
            torch::Dispatcher::singleton()
                .findSchemaOrThrow("mlpui_torchmdnet_extensions::get_neighbor_pairs_fwd", "")
    ...
    static tensor_list backward(AutogradContext* ctx, tensor_list grad_outputs) {
        ...
        static auto backward =
            torch::Dispatcher::singleton()
                .findSchemaOrThrow("mlpui_torchmdnet_extensions::get_neighbor_pairs_bkwd", "")
...
TORCH_LIBRARY_IMPL(mlpui_torchmdnet_extensions, CompositeImplicitAutograd, m) {
...
// TORCH_LIBRARY_IMPL(mlpui_torchmdnet_extensions, CPU, m) {
//     m.impl("get_neighbor_pairs",
//            [](const std::string& strategy, const Tensor& positions, const Tensor& batch,
//               const Tensor& box_vectors, bool use_periodic, const Scalar& cutoff_lower,
//               const Scalar& cutoff_upper, const Scalar& max_num_pairs, bool loop,
...
// TORCH_LIBRARY_IMPL(mlpui_torchmdnet_extensions, CUDA, m) {
//     m.impl("get_neighbor_pairs",
//            [](const std::string& strategy, const Tensor& positions, const Tensor& batch,
//               const Tensor& box_vectors, bool use_periodic, const Scalar& cutoff_lower,
//               const Scalar& cutoff_upper, const Scalar& max_num_pairs, bool loop,
...
// TORCH_LIBRARY_IMPL(mlpui_torchmdnet_extensions, Autograd, m) {
