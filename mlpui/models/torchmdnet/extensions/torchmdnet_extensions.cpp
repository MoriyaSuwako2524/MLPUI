...
extern "C" {
  /* Creates a dummy empty mlpui_torchmdnet_extensions module that can be imported from Python.
     The import from Python will load the .so consisting of this file
     in this extension, so that the TORCH_LIBRARY static initializers
     below are run. */
  PyObject* PyInit_mlpui_torchmdnet_extensions(void)
  {
      static struct PyModuleDef module_def = {
          PyModuleDef_HEAD_INIT,
          "mlpui_torchmdnet_extensions",   /* name of module */
...
TORCH_LIBRARY(mlpui_torchmdnet_extensions, m) {
