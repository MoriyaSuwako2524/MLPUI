...
# The extensions will be available under torch.ops.mlpui_torchmdnet_extensions, but you can add wrappers here to make them more convenient to use.
...
def is_current_stream_capturing():
    ...
    _is_current_stream_capturing = (
        torch.ops.mlpui_torchmdnet_extensions.is_current_stream_capturing
    )
...
def get_neighbor_pairs_kernel(
    ...
    """
    return torch.ops.mlpui_torchmdnet_extensions.get_neighbor_pairs(
        strategy,
        positions,
        batch,
        box_vectors,
...
@torch.library.register_fake("mlpui_torchmdnet_extensions::get_neighbor_pairs_bkwd")
def _(
...
@torch.library.register_fake("mlpui_torchmdnet_extensions::get_neighbor_pairs_fwd")
def _(
    strategy: str,
    positions: Tensor,
    batch: Tensor,
