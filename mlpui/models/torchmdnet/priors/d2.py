...
from mlpui.models.torchmdnet.priors.base import BasePrior
from mlpui.models.torchmdnet.models.utils import OptimizedDistance, scatter
import torch as pt
...
class D2(BasePrior):
    ...
    Examples
    --------
    >>> from mlpui.models.torchmdnet.priors import D2
    >>> prior = D2(
